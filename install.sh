#!/bin/bash
# Termux-Games
# Coded by: MrmX (You dont become a coder by just changing the credits)
# Github: https://github.com/Whomrx666/Termux-Games
...
echo "play Games in Termux by Mr.X"
...
echo "Visit https://whomrxhackers.blogspot.com To learn Basic To Advance About Termux" | lolcat -a
echo ""
